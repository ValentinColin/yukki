...
class Sondage(commands.Cog):
	...
	@commands.command(name='sondage', 
			...
			help=('Crée un sondage de la forme:\n'
	...
	async def exemple(self, ctx: commands.Context):
		...
		description = ('Voici un petit exemple de la commande à écrire pour pour crée un sondage:\n'
		...
		options = ['time=1', 'Moins de 18 ans', 'Plus de 18 ans', 'Plus de 30 ans', 'Plus de 50 ans']
